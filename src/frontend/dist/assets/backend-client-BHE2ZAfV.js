...
import { b as Subscribable, p as pendingThenable, d as resolveEnabled, s as shallowEqualObjects, e as resolveStaleTime, n as noop$1, f as environmentManager, i as isValidTimeout, t as timeUntilStale, g as timeoutManager, h as focusManager, k as fetchState, l as replaceData, m as notifyManager, o as hashKey, q as getDefaultState, r as reactExports, v as shouldThrowError, w as useQueryClient, j as jsxRuntimeExports } from "./index-nodcIggE.js";
...
function makeSeasonsWithParts(numSeasons, epsPerSeason, partsPerEp) {
  return Array.from({ length: numSeasons }, (_, si) => ({
    seasonNumber: si + 1,
    title: `Season ${si + 1}`,
...
function getDefaultContent() {
  return [
    // ── Movies (no seasons) ────────────────────────────────────────────────
    {
      ...
      description: "An epic journey across the cosmos where humanity discovers it is not alone in the universe.",
      category: "movie",
      genre: "Sci-Fi",
      year: 2024,
      rating: 4.8,
    ...
    },
    {
      ...
      description: "A rogue agent uncovers a global conspiracy that reaches the highest levels of government.",
      category: "movie",
      genre: "Action",
      year: 2024,
      rating: 4.5,
    ...
    },
    {
      id: "3",
      title: "Neon Requiem",
      description: "In a rain-soaked cyberpunk city, a detective investigates murders tied to illegal neural implants.",
      category: "movie",
      genre: "Thriller",
      year: 2023,
      rating: 4.6,
    ...
    },
    {
      ...
      description: "Two astronauts stranded near Jupiter must find a way home before their oxygen runs out.",
      category: "movie",
      genre: "Drama",
      year: 2024,
      rating: 4.7,
    ...
    },
    {
      ...
      description: "A war drama set in the Pacific that redefines courage and sacrifice.",
      category: "movie",
      genre: "War",
      year: 2023,
      rating: 4.4,
    ...
    },
    {
      ...
      description: "An underground civilisation is discovered beneath Antarctica, upending all of human history.",
      category: "movie",
      genre: "Adventure",
      year: 2024,
      rating: 4.3,
    ...
    // ── Anime (with seasons) ───────────────────────────────────────────────
    {
      ...
      description: "A demon slayer reincarnates in the future and must master forgotten techniques to defeat an ancient evil.",
      category: "anime",
      genre: "Action",
      year: 2024,
      rating: 4.9,
    ...
    },
    {
      ...
      description: "Students at an interstellar academy compete to claim the most powerful mech in the galaxy.",
      category: "anime",
      genre: "Mecha",
      year: 2024,
      rating: 4.7,
    ...
    },
    {
      ...
      description: "A phantom thief with supernatural abilities steals cursed artefacts to protect the innocent.",
      category: "anime",
      genre: "Fantasy",
      year: 2023,
      rating: 4.8,
    ...
    },
    {
      ...
      description: "Parallel timelines collide as two protagonists unknowingly alter each other's fates.",
      category: "anime",
      genre: "Isekai",
      year: 2024,
      rating: 4.6,
    ...
    },
    {
      id: "11",
      title: "Oni Warriors",
      description: "A band of warriors with oni blood fight to protect a realm teetering on the edge of collapse.",
      category: "anime",
      genre: "Shonen",
      year: 2024,
      rating: 4.5,
    ...
    },
    {
      ...
      description: "A hacker anime following a genius programmer who dives into a deadly virtual reality world.",
      category: "anime",
      genre: "Cyberpunk",
      year: 2023,
      rating: 4.4,
    ...
    // ── Dramas (with seasons + parts for some) ────────────────────────────
    {
      ...
      description: "Political intrigue, forbidden romance, and betrayal in a fictional Asian dynasty spanning four generations.",
      category: "drama",
      genre: "Historical",
      year: 2024,
      rating: 4.8,
    ...
    },
    {
      id: "14",
      title: "Glass Heart",
      description: "A surgeon and a musician fall in love but are torn apart by family secrets and hidden pasts.",
      category: "drama",
      genre: "Romance",
      year: 2024,
      rating: 4.7,
    ...
    },
    {
      ...
      description: "A legal thriller following a charismatic defence attorney who discovers corruption at every level of the justice system.",
      category: "drama",
      genre: "Legal",
      year: 2023,
      rating: 4.6,
    ...
    },
    {
      ...
      description: "A time-slip romance where letters from the past guide two souls toward each other across decades.",
      category: "drama",
      genre: "Romance",
      year: 2024,
      rating: 4.9,
    ...
    },
    {
      ...
      description: "An arranged marriage between rivals blossoms into an unbreakable alliance during wartime.",
      category: "drama",
      genre: "Historical",
      year: 2024,
      rating: 4.5,
    ...
    },
    {
      ...
      description: "A neo-noir crime drama set in a sprawling city where nothing is ever what it seems.",
      category: "drama",
      genre: "Crime",
      year: 2023,
      rating: 4.4,
    ...
    // ── Music (no seasons) ─────────────────────────────────────────────────
    {
      ...
      description: "An ambient electronic journey through synthesised cosmic soundscapes recorded over two years.",
      category: "music",
      genre: "Electronic",
      year: 2024,
      rating: 4.9,
    ...
    },
    {
      ...
      description: "A soul and R&B album exploring themes of resilience, identity, and love after loss.",
      category: "music",
      genre: "R&B",
      year: 2024,
      rating: 4.7,
    ...
    },
    {
      ...
      description: "High-energy synthwave that draws influence from 80s retrofuturism and modern electronica.",
      category: "music",
      genre: "Synthwave",
      year: 2024,
      rating: 4.6,
    ...
    },
    {
      ...
      description: "A meditative acoustic album featuring guitar, piano, and the natural sounds of the Himalayas.",
      category: "music",
      genre: "Ambient",
      year: 2023,
      rating: 4.8,
    ...
    },
    {
      id: "23",
      title: "Urban Pulse",
      description: "Hip-hop beats and spoken word poetry documenting life in the city across 14 tracks.",
      category: "music",
      genre: "Hip-Hop",
      year: 2024,
      rating: 4.5,
    ...
    },
    {
      ...
      description: "Orchestral compositions inspired by classic film scores, performed by a 70-piece orchestra.",
      category: "music",
      genre: "Orchestral",
      year: 2024,
      rating: 4.9,
...
function useContentByCategory(category) {
  return useQuery({
...
function useContentById(id2) {
  return useQuery({
    queryKey: ["content", "id", id2],
    queryFn: async () => loadLocal().find((i) => i.id === id2) ?? null,
    enabled: !!id2
  });
}
function useSearchContent(term) {
  return useQuery({
    ...
    queryFn: async () => {
      ...
      return loadLocal().filter(
        (i) => i.title.toLowerCase().includes(lower) || i.description.toLowerCase().includes(lower) || i.genre.toLowerCase().includes(lower)
      );
    },
...
function useAddContent() {
  ...
  return useMutation({
    mutationFn: async (input) => {
      const newItem = { ...input, id: String(++_localId) };
...
function useUpdateContent() {
  ...
  return useMutation({
    mutationFn: async ({
      ...
      const items = loadLocal();
      const idx = items.findIndex((i) => i.id === id2);
      if (idx === -1) throw new Error("Not found");
      const updated = { ...input, id: id2 };
      items[idx] = updated;
      saveLocal(items);
      return updated;
    },
...
function useDeleteContent() {
  ...
  return useMutation({
    mutationFn: async (id2) => {
      const items = loadLocal().filter((i) => i.id !== id2);
      saveLocal(items);
    },
    onSuccess: () => qc.invalidateQueries({ queryKey: ["content"] })
  });
...
export {
  ...
  useContentByCategory as a,
  useSearchContent as b,
  useContentById as c,
  useAddContent as d,
  useUpdateContent as e,
  useDeleteContent as f,
  useConstant as g,
  usePresence as h,
  isHTMLElement as i,
